...
export default function Homepage() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <div className=" mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Find hundreds of exercises
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Search for exercises by their name, target muscles, body parts, and
            equipment used.
          </p>
      ...
      <HomeTeaser
        exerciseCardData={bodyPartImages}
        subpath="bodyPart"
        title="Exercises by body part"
      />
      <HomeTeaser
        exerciseCardData={equipmentImages}
        subpath="equipment"
        title="Exercises by equipment"
      />

      <HomeTeaser
        exerciseCardData={targetMuscleImages}
        subpath="target"
